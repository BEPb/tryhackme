...
Как только мы нажмем на эту вкладку, мы увидим, что она перенаправляет на URL-адресhttp://hrms.thm/url.php?id=192.168.2.10/trainingbanner.jpg, который показывает обучающий контент.
