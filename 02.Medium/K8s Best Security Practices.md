...
1. Обновление (основного) узла плоскости управления (обновление компонентов в следующем порядке: etcd, 
   kube-apiserver, kube-controller-manager, kube-scheduler, cloud controller manager) 
2. Если в кластере есть дополнительные узлы плоскости управления, обновите их.
3. Обновление рабочих узлов
4. Обновите клиенты, такие как kubectl 
5. Внесите изменения в манифесты и ресурсы на основе изменений в новой версии (например, если некоторые из ваших 
