...
В этом разделе мы рассмотрим прошивку, проверим строки и сделаем дамп файловой системы из образа. Следующий раздел 
будет посвящен монтированию и исследованию файловой системы.
